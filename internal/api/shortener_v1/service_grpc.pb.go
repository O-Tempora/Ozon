...
type ShortenerServiceClient interface {
	GetShortenedURL(ctx context.Context, in *LongURL, opts ...grpc.CallOption) (*ShortenedURL, error)
	GetURL(ctx context.Context, in *ShortenedURL, opts ...grpc.CallOption) (*LongURL, error)
}
...
func (c *shortenerServiceClient) GetShortenedURL(ctx context.Context, in *LongURL, opts ...grpc.CallOption) (*ShortenedURL, error) {
	out := new(ShortenedURL)
	err := c.cc.Invoke(ctx, "/shortener.v1.ShortenerService/GetShortenedURL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shortenerServiceClient) GetURL(ctx context.Context, in *ShortenedURL, opts ...grpc.CallOption) (*LongURL, error) {
	out := new(LongURL)
	err := c.cc.Invoke(ctx, "/shortener.v1.ShortenerService/GetURL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShortenerServiceServer interface {
	GetShortenedURL(context.Context, *LongURL) (*ShortenedURL, error)
	GetURL(context.Context, *ShortenedURL) (*LongURL, error)
...
func (UnimplementedShortenerServiceServer) GetShortenedURL(context.Context, *LongURL) (*ShortenedURL, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetShortenedURL not implemented")
}
func (UnimplementedShortenerServiceServer) GetURL(context.Context, *ShortenedURL) (*LongURL, error) {
...
func _ShortenerService_GetShortenedURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LongURL)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShortenerServiceServer).GetShortenedURL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shortener.v1.ShortenerService/GetShortenedURL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShortenerServiceServer).GetShortenedURL(ctx, req.(*LongURL))
	}
...
func _ShortenerService_GetURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shortener.v1.ShortenerService/GetURL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShortenerServiceServer).GetURL(ctx, req.(*ShortenedURL))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ShortenerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ShortenerService_GetShortenedURL_Handler,
		},
		{
			MethodName: "GetURL",
	...
	Metadata: "api/shortener_v1/service.proto",
}
